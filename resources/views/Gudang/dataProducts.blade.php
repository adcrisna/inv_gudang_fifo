                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-xs btn-primary btn-transaksi-product"><i
                                                    class="fa fa-edit">
                                                    In/Out</i></button> &nbsp;
                                            <button class="btn btn-xs btn-warning btn-laporan-product"><i
                                                    class="fa fa-download">
                                                    Laporan</i></button> &nbsp;
                                            {{-- <a href="{{ route('staff.print', @$value->id) }}"><button
                                                    class=" btn btn-xs btn-warning" target="_blank"><i
                                                        class="fa fa-download"> Laporan</i></button></a> --}}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
    ...
    <div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('staff.print') }}" method="post">
                    @csrf
    ...
    <div class="modal fade" id="modal-form-transaksi-product" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('staff.transaksi') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group has-feedback">
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $('#data-product').on('click', '.btn-laporan-product', function() {
