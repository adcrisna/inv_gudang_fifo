...
@section('content')
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active">Data History Barang Masuk</li>
        </ol>
        <br />
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    <div class="box-header">
                        <h3 class="box-title">Data History Barang Masuk</h3>
                            ...
                            <tbody>
                                @foreach (@$product as $key => $value)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('staff.hapus.masuk', @$value->id) }}"><button
