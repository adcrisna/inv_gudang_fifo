        ...
        <aside class="main-sidebar control-sidebar-dark">
            <section class="sidebar">
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="{{ route('staff.product') }}">
                            <i class="fa fa-cubes"></i> <span>Data Barang</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('staff.masuk') }}">
                            <i class="fa fa-list-alt"></i> <span>History Barang Masuk</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('staff.keluar') }}">
                            <i class="fa fa-list-alt"></i> <span>History Barang Keluar</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('logout') }}">
